$(document).ready(function() {
	...
	$(".mc-item-wrap ul").each(function () {
		$(this).after("<div class='mc-item-wrap_af'></div>");
	});
	$(".mc-toggle").click(function () {
		if ($(this).parent().parent().children("ul").is(":visible")) {
			$(this).parent().parent().children("ul").slideUp();			
			$(this).parent().parent().children(".mc-item-wrap_af").hide(0);
		} else{
			$("body .mc-wrap .mc-item-wrap > ul , .mc-item-wrap_af").hide();
			$(".mc-item-wrap").removeClass("active");
			$(this).parent().parent().children(".mc-item-wrap_af").slideDown();
